...
const items = [
  ...
  },
  {
    ...
    feeType: 'percentage',
    feeColor: 'tertiary-container',
    image: 'https://example.com/uniqlo-tee.jpg'
  },
  {
    id: 4,
    name: 'Tamagotchi Mini 4',
    price: 1200000,
    category: 'MAINAN',
    ...
    feeType: 'percentage',
    feeColor: 'tertiary-container',
    image: 'https://example.com/tamagotchi.jpg'
  },
  {
    id: 5,
    name: 'Shiseido Ultimate Revitalizing Cream',
    price: 350000,
    category: 'SKINCARE',
    categoryColor: 'accent-purple',
    fee: 10,
    feeType: 'percentage',
    feeColor: 'tertiary-container',
    image: 'https://example.com/shiseido-cream.jpg'
  },
  {
    id: 6,
    ...
    feeType: 'percentage',
    feeColor: 'tertiary-container',
    image: 'https://example.com/pocky.jpg'
  }
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="px-margin pt-6">
        ...
        <div className="flex justify-center gap-4 mb-8">
          <button
            className={`w-10 h-10 flex items-center justify-center border-2 border-black font-label-bold rounded-full shadow-neubrutal-sm active:translate-y-0.5 active:shadow-none transition-all ${currentPage === 1 ? 'bg-gray-300 text-gray-500' : 'bg-white text-on-surface hover:bg-accent-pink'}`}
          ...
          {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
            <button
              key={page}
              className={`w-10 h-10 flex items-center justify-center border-2 border-black font-label-bold rounded-full shadow-neubrutal-sm active:translate-y-0.5 active:shadow-none transition-all ${currentPage === page ? 'bg-accent-pink text-white' : 'bg-white text-on-surface hover:bg-accent-pink'}`}
          ...
          <button
            className={`w-10 h-10 flex items-center justify-center border-2 border-black font-label-bold rounded-full shadow-neubrutal-sm active:translate-y-0.5 active:shadow-none transition-all ${currentPage === totalPages ? 'bg-gray-300 text-gray-500' : 'bg-white text-on-surface hover:bg-accent-pink'}`}
            onClick={() => handlePageChange(currentPage + 1)}
