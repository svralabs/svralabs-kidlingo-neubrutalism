...
const mockTrips = [
  {
    ...
    buttonBg: 'bg-primary-container',
    buttonText: 'text-on-primary-container'
  },
  {
    id: 2,
    ...
    buttonBg: 'bg-secondary-container',
    buttonText: 'text-on-secondary-container'
  }
];
...
export default function JastipHome() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="fixed top-0 left-0 w-full z-50 px-4 h-16 flex items-center justify-between bg-primary border-b-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
