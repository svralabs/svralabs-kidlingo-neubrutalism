...
const ThirtySpaceLoaderShowcase = () => {
  return (
    <div className="flex-grow pt-32 pb-xl px-margin max-w-7xl mx-auto w-full">
      <section className="mb-xl">
        ...
        <p className="font-body-md text-on-surface-variant max-w-2xl text-lg">
          High-contrast, brutalist loader components designed for maximum legibility and structural impact. Built for loading states that refuse to be boring.
        </p>
      </section>
      <section className="mb-xl">
        <div className="flex items-center gap-sm mb-lg">
          <span className="w-8 h-8 bg-accent-purple border-2 border-black rounded-full flex items-center justify-center brutalist-shadow">
            <span className="material-symbols-outlined text-white text-sm">progress_activity</span>
          </span>
          <h2 className="font-heading-card text-heading-card text-on-surface">Standard Loader</h2>
        </div>
...
export default ThirtySpaceLoaderShowcase;
