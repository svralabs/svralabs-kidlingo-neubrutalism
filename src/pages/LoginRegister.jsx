          ...
          {activeTab === 'masuk' ? (
            <form className="space-y-md" onSubmit={(e) => handleSubmit(e, 'login')}>
              <div className="space-y-sm">
                ...
                />
                {errors.login.email && <p className="text-error text-sm">{errors.login.email}</p>}
              </div>
              <div className="space-y-sm">
                ...
                <input
                  ...
                  onChange={(e) => handleInputChange(e, 'login')}
                />
                {errors.login.password && <p className="text-error text-sm">{errors.login.password}</p>}
            ...
            <form className="space-y-md" onSubmit={(e) => handleSubmit(e, 'register')}>
              <div className="space-y-sm">
                ...
                />
                {errors.register.fullName && <p className="text-error text-sm">{errors.register.fullName}</p>}
              </div>
              <div className="space-y-sm">
                <label className="font-label-bold text-label-bold block">Email</label>
                <input
                  ...
                  onChange={(e) => handleInputChange(e, 'register')}
                />
                {errors.register.email && <p className="text-error text-sm">{errors.register.email}</p>}
              </div>
              <div className="space-y-sm">
                ...
                <input
                  ...
                  onChange={(e) => handleInputChange(e, 'register')}
                />
                {errors.register.phone && <p className="text-error text-sm">{errors.register.phone}</p>}
              </div>
              <div className="space-y-sm">
                ...
                <textarea
                  ...
                  onChange={(e) => handleInputChange(e, 'register')}
                ></textarea>
                {errors.register.address && <p className="text-error text-sm">{errors.register.address}</p>}
              </div>
              <div className="space-y-sm">
                <label className="font-label-bold text-label-bold block">Password</label>
                <input
                  ...
                  onChange={(e) => handleInputChange(e, 'register')}
                />
                {errors.register.password && <p className="text-error text-sm">{errors.register.password}</p>}
              </div>
              <button
                type="submit"
