  ...
  return (
    <div className="neubrutalist-card bg-white min-w-[280px] rounded-xl overflow-hidden flex-shrink-0">
      <div className={`h-32 ${trip.bgColor} relative overflow-hidden`}>
        <img className="w-full h-full object-cover" alt={trip.title} src={trip.image} />
        {trip.isLive && (
      ...
      <div className="p-4">
        ...
        <button className={`neubrutalist-btn ${trip.buttonColor} w-full py-2 rounded-full font-label-bold ${trip.textColor}`}>
          Lihat Katalog
        </button>
      </div>
    </div>
